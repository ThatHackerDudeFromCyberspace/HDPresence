...
## Config.json
There should be a config.json file accessible at `/opt/hdpresence/config.json` in the container, the contents should be as follows:
...
## Other Paths
Images will be uploaded, cached and served from `/opt/hdpresence/cache`